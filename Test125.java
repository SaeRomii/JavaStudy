...
○ Wrapper 클래스
   ...
   2. 기본 자료형인
	  ...
	  Byte, Short, Integer, Long, Float, Double, Character, Boolean 의		(클래스 이름이라 첫글자 대문자)
	  ...
	  ex) java.lang.Integer 클래스
		  ...
		  float floatVlaue(), double doubleValue()
...
○ 오토 박싱(Auto-Boxing)과 오토 언박싱(Auto-Unboxing)
   ...
   int a=10, b;
   Integer ob;		Integer는 클래스
   ob=a;			객체타입에 가두는것 박싱 (자동으로 하니까 오토박싱)
   // 기본 자료형(int)이 Integer 형으로 자동 변환
   // 실제로는... 『ob = new Integer(10);』 이렇게 작성해야함
   // 값을 주소에 담겠다는거라서 원래는 말 안됨!! 
...
public class Test125
{
	public static void main(String[] args)
	{
		...
		b = a;					// int형 변수에다가 int형 데이터(자료) 담겠다
		c = new Integer(0);		// 생성자 호출하고 0을 넣는거 원래 c에는 주소가 담겨져 있어야함
		...
		b = c.intValue();	//intValue메소드라서 그냥 언박싱이라고 함
		...
		System.out.println("d.toString() : " + d.toString());
		//--==>> d.toString() : 12.345
		// JDK 1.5 이상부터 적용 Wrapper 클래스라서

		d = 10;			// Object d = 10;	오토박싱
		System.out.println("d.toString() : " + d.toString());
		//--==>> d.toString() : 10
