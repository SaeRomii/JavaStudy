...
class Test
{
	...
	public static class StaticNested
	{
		...
		void write()
		{
			...
			System.out.println("a : " + a);			// 78번째 줄 static int로 접근 가능
			//System.out.println("b : " + b);		// 79번째 줄에서 static 아니라서 접근 불가능 에러 발생(컴파일 에러)
			System.out.println("c : " + c);			// static 클래스 안에 있어서 접근 가능
		}
	}
...
public class Test117
{
	public static void main(String[] args)
	{
		...
		*/
		...
		//--==>> 에러 발생(컴파일 에러)
		// static 클래스 내부에서 인스턴스 생성은 가능하지만, 외부에서는 단독으로 인스턴스 생성이 불가능함
		...
		System.out.println("a : " + Test.a);		// a는 static 클래스 변수라서 직접 접근 가능
		//--==>> 10
