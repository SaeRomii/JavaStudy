...
/*
  ...
  조건식을 먼저 비교하여
  조건식의 결과가 참인 경우, 특징 영역을 반복 수행하는 문장으로
...
public class Test043
{
	public static void main(String[] args)
	{
		...
		*/
		...
		// 주요 변수 선언
		// 1부터 차례로 담아 1씩 증가하는 변수 선언 및 초기화(a를 1로 초기화)
		int a = 1;

		// 누적합을 연산하여 담아낼 변수 선언 및 초기화 (누적합 담는 변수는 0으로 해줌 기준이없어서)
		int sum = 0;
		...
		while (a<=100)
		{
			sum += a;	// sum을 a만큼 증가시켜라
			a++;		//a를 1만큼씩 증가
		}

		// 결과 출력
		System.out.println("1부터 100까지의 합 : " + sum);  // 결과 출력 부분은 {} 밖에
