...
public class Test164
{
	...
	public static void main(String[] args)
	{
		...
		{
			System.out.println(findTel3 + " 데이터가 존재합니다.");
		}
		else
			System.out.println(findTel3 + " 데이터가 존재하지 않습니다.");
		System.out.println();
		//--==>> 010-7101-9504 데이터가 존재하지 않습니다.
		// key값만 삭제했어도 value값 같이 삭제
