...
public class Test093
{
	...
	// ※ 인스턴스 변수는 동일한 클래스의 메소드에서는 바로 접근하는 것이 가능하지만
	...
	{
		System.out.println("클래스 변수   a : " + a);
		//System.out.println("인스턴스 변수 b : " + b);		//-- 에러발생 20행 접근 안돼서
	}
	public static void main(String[] args)
	{
		...
		// 클래스명 Test093.a 쓰는거 가능 왜냐면 static 들어간 클래스메소드라서 여기서 먼저 선점했음~!
		// 다른곳에서 쓸땐 this쓰는거 말하는거임
		//--==>> main() → 클래스 변수 a : 10

		System.out.println("main() → 클래스 변수 a : " + a);
		//-- 같은 클래스 내부에ㅔ 존재하기 때문에
		//	 클래스 이름은 생략 가능
		//--==>> main() → 클래스 변수 a : 10
