...
/*
※ Calendar 클래스는 추상클래스(인스턴스 생성 불가능)이기 때문에 객체를 생성할 수 없다.
   (추상 클래스 : 미완성된 클래스)
...
○ Calendar 클래스 객체(인스턴스)를 생성할 수 있는 방법
   ...
   2. Calendar ob2 = new GregorianCalendar(); 그레골리언캘린더인가.. 여튼 우리가 쓰는 달력이름
...
public class Test137
{
	public static void main(String[] args)
	{
		...
		*/
		...
		rightNow2.set(2021, 6, 9);		// 2021-7-9 출력하려면 월에 -1해야함

		System.out.println(rightNow2.get(Calendar.DAY_OF_WEEK));
		//--==>> 6 → 금요일

		System.out.println(week2[rightNow2.get(Calendar.DAY_OF_WEEK)-1]);	//그냥 출력하면 금요일은 6인데 배열은 0번째부터니까-1
		//--==>> 금요일
