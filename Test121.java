...
○ import 문
   ...
   ※ JDK 1.5 부터는 imprt 다음에 『static』 키워드를 붙임으로써
      정적으로 패키지를 import 할 수 있는 기능을 제공하게 되었다.
	  만약 패키지를 정적으로 import 한 경우라면
	  모든 접근 가능한 메소드와 멤버 변수들은 접두사(예 → ob. sc, br)를 붙이지 않고
	  사용하는 것이 가능하다.
...
public class Test121 //extends Object
{
	...
	*/
	...
	public static void main(String[] args)
	{
		...
		System.out.println(ob.toString());	// 실행됨 Object가 가지고 있는 기본 메소드라서
		//--==>> Test121@15db9742
		//-- 클래스명@메모리주소 아님(자바는 직접적으로 접근하는거 허락하지 않아서)
		//-- 클래스명@해시코드임~! 자바가 스스로 객체를 구분하기 위해 임의로 부여하는 식별 번호

		System.out.println(ob);		// Object가 가지고 있는 메소드
		//--==>> Test121@15db9742
